...
<html>
    <head>
        <title>Cetak Semua Data Detail Pasien</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH PASIEN RUMAH SAKIT</h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%">Ruang Rawat</th><th>Nama Pasien</th><th>Tanggal Masuk</th><th>Keluarga</th><th>No. Handphone</th>
								</tr>
								</thead>
							<tbody>
