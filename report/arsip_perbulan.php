            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PASIEN PER BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                <thead>
								<tr>
									<th>No.</th><th width="18%">Ruang Rawat</th><th>Nama Pasien</th><th width="15%"><center>Keluarga</center></th><th width="10%">Tgl. Masuk</th><th><center>No. Handphone</center></th><th><center>Keterangan</center></th>
								</tr>
								</thead>
							<tbody>
                            ...
                            $sql = "SELECT * FROM data_pasien WHERE substr(tgl_masuk,1,7)='$ambilthn-$ambilbln'";
